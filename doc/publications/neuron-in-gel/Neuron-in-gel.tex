...
$
\begin{array}{c}
\includegraphics[height=8cm]{figure/neuron_0deg_MPS_ccdf_compare.pdf} 
\end{array}
$
\end{center}
...
\begin{center}
\begin{tabular}{ c c c }
volume fraction & strain amplification for $\epsilon_{\text{bulk}}=0.1$ & strain amplification for $\epsilon_{\text{bulk}}=0.16$ \\
\hline \hline
50$\%$ & 1.18 & 1.12 \\ 
25$\%$ & 1.40 &  1.43\\ 
10$\%$ & 1.64 & 1.73 \\ 
5$\%$ & 1.74 & 1.90\\
1$\%$ & 1.98 & 2.42\\  \hline \hline
\end{tabular}
\end{center}
\caption{Parameters of Eq.\ \eqref{eq:trns_iso_constants} for modeling neuron structure. The transverse elastic modulus, $E_T$, is based on measurements of the neuron cell body by Simon et al.\ \cite{Simon:2016ig}. The shear modulus of the neuron structure is assumed to be isotropic. Therefore, $G_A = \mu = 0.577$ kPa.}
...
Less than 1$\%$ of the neuron structure experiences a local-strain amplification of more than two times for 10$\%$ applied bulk strain, while approximately $3\%$ of the neuron structure experiences a local-strain amplification of more than two times for 16$\%$ applied bulk strain.
...
$
\begin{array}{c}
\includegraphics[height=8cm]{figure/neuron_compare_t_ccdf.pdf} 
\end{array}
$
\end{center}
...
$
\begin{array}{cc}
\includegraphics[height=7cm]{figure/neuron_45deg_MPS_ccdf_compare.pdf} &
\includegraphics[height=7cm]{figure/neuron_90deg_MPS_ccdf_compare.pdf} \\
(a) & (b) 
\end{array}
$
\end{center}
...
\blue{For both non painful and painful ligament loading at 45 and 90 degrees, the average MPS in the neuron structure is greater than the applied bulk strain on the surrounding gel. The strain distributions shift to the right with larger applied bulk strain, but the normalized distributions (shown in insets) are nearly the same.Compared to the 0 degree loading case (Fig.\ \ref{fig:neuron_ccdf_0deg_mps}, the average MPS for 45 and 90 degree loading is greater.}

When the collagen gel is loaded at 45 degrees, approximately 8$\%$ and 7$\%$ of the neuron structure experiences a local-strain amplification of more than two times for non painful and painful ligament loading, respectively. When the collagen gel is loaded at 90 degrees, approximately 45$\%$ and 58$\%$ of the neuron structure experiences a local-strain amplification of more than two times for non painful and painful ligament loading, respectively. Furthermore, when the collagen gel is loaded at 90 degrees, approximately 1$\%$ of the neuron structure experiences a local-strain amplification of four times for both non painful and painful ligament loading.

Although the average strain amplification in the neuron is greater when loaded at 45 degrees than when loaded at 0 degrees, the tail of the ccdf for the 45 degree case is shorter with a maximum strain amplification that is less than 3 times. In the 90 degree loading case, the average strain amplification is approximately double the applied bulk strain and the tail of the ccdf reaches to nearly 6 times that of the applied bulk strain. 
