...
\end{equation}
%
where $f$ is a probability density function and $X$ is a random variable (maximum principal strain in our case). Equation \ref{eq:comp_cdf} measures the probability that the neuron experiences a maximum principal strain that is greater than or equal to $x$. The complementary cdf for the neuron structure is shown in Fig.\ \ref{fig:neuron_cdf} for different angles of applied load.
%
\begin{figure}[ht]
\begin{center}
$
\begin{array}{cc}
\includegraphics[height=5cm]{figure/rot0_FT_dspBC50_a30_128_1920_cdf_neuron_compare_stps.pdf} &
\includegraphics[height=5cm]{figure/rot90_FT_dspBC50_a30_128_1920_cdf_neuron_compare_stps.pdf} \\
(a) & (b)
\end{array}
$
\end{center}
\caption{\label{fig:neuron_cdf} Complementary cdf of neuron structure as a function of normalized maximum principal strain ($\varepsilon_1$) for applied loads at (a) 0 degrees and (b) 90 degrees. For each angle, the complementary cdf for 6, 10, 16 (pain threshold), and 20 percent bulk strain is shown. The values of $\varepsilon_1$ are normalized by the applied bulk strain on the surrounding collagen gel.}
\end{figure}
%
For both angles of applied load, there are regions in the neuron where the local strain is more than twice as large as the applied bulk strain (see tail of distributions in Fig.\ \ref{fig:neuron_cdf}). In both cases the distributions become more narrow as the applied load is increased. Interestingly, the distributions converge to the distribution corresponding to the load at the pain threshold (16$\%$). 

Additional insight can be gained by separating the strain distribution of neuron into contributions from the cell bodies and axons. The complimentary cdfs for the cell bodies and axons are plotted in Figs.\ \ref{fig:cellbodies_cdf} and \ref{fig:axons_cdf}, respectively. For both load angles, the overall shape of the distribution remains the same for all bulk strains. For an applied load of 0 degrees, the distribution is relatively narrow with more than 90$\%$ of the neuron experience larger strain locally than the applied bulk strain on the collagen gel. For an applied load of 90 degrees, the distribution is significantly wider with two steps that indicate two regimes of strain in cell bodies. Additionally, for the applied load of 90 degrees, the strain distribution tightens as the applied bulk strain increases.
%
\begin{figure}[ht]
\begin{center}
$
\begin{array}{cc}
\includegraphics[height=5cm]{figure/rot0_FT_dspBC50_a30_128_1920_cdf_cellbodies_compare_stps.pdf} & 
\includegraphics[height=5cm]{figure/rot90_FT_dspBC50_a30_128_1920_cdf_cellbodies_compare_stps.pdf} \\
(a) & (b)
\end{array}
$
\end{center}
\caption{\label{fig:cellbodies_cdf} Complementary cdf of cell bodies as a function of normalized maximum principal strain ($\varepsilon_1$) for applied loads at (a) 0 degrees and (b) 90 degrees. For each angle, the complementary cdf for 6, 10, 16 (pain threshold), and 20 percent bulk strain is shown. The values of $\varepsilon_1$ are normalized by the applied bulk strain on the surrounding collagen gel.}
\end{figure}
%
...
$
\begin{array}{cc}
\includegraphics[height=5cm]{figure/rot0_FT_dspBC50_a30_128_1920_cdf_axons_compare_stps.pdf} &
\includegraphics[height=5cm]{figure/rot90_FT_dspBC50_a30_128_1920_cdf_axons_compare_stps.pdf} \\
(a) & (b)
\end{array}
$
\end{center}
\caption{\label{fig:axons_cdf} Complementary cdf of normalized maximum principal strain ($\varepsilon_1$) in axons for applied loads at (a) 0 degrees and (b) 90 degrees. For each angle, the complementary cdf for 6, 10, 16 (pain threshold), and 20 percent bulk strain is shown. The values of $\varepsilon_1$ are normalized by the applied bulk strain that is applied to the surrounding collagen gel. }
\end{figure}
%
