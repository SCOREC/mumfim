...
The large computational demands that arise from the mesh of a complex cell geometry coupled by the use of a multi-scale model is accommodated through the AMSI library, which is capable of efficiently managing the parallel execution spaces of the macroscopic and microscopic scale calculations. \red{Bill: Can you add some more discussion?}
