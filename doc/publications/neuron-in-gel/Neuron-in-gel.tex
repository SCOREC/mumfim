...
$
\end{center}
\caption{\label{fig:neuron_cdf} Complementary cdfs of normalized maximum principal strain ($\varepsilon_1$) in the neuron for applied loads at (a) 0 degrees, (b) 45 degrees, and (c) 90 degrees. For each angle, the complementary cdfs for bulk strains below and at the pain threshold (16$\%$) are shown. The values of $\varepsilon_1$ are normalized by the applied bulk strain ($\varepsilon_{\text{bulk}}$) that is applied to the surrounding collagen gel.  }
\end{figure}
%
...
$
\end{center}
\caption{\label{fig:neuron_MPS} Maximum principal strain for applied loads at 0 degrees (first row), 45 degrees (second row), and 90 degrees (third row). Bulk strains of 10$\%$ and 16$\%$ are considered. Note that the color bar ranges from 5$\%$ to 30$\%$ strain for bulk strain of 10$\%$ and from 10$\%$ to 40$\%$ for 16$\%$ bulk strain.}
\end{figure}
%
...
\end{figure}
%
The three angles of applied load schematically shown in Fig.\ \ref{fig:analysis_schematic} are considered. Depending on the loading angle, axes 1 and 2 will experience either tensile or compressive axial strains. For tensile strains, the complementary cumulative distribution function (ccdf), Eq.\ \eqref{eq:comp_cdf}, is applied so that one can read ``X percent (ordinate) of the structure contains \textit{at least} Y tensile strain (abscissa)" from the distribution plot. On the other hand, for compressive strains, which are negative in value, the cumulative distribution function (cdf) is applied so that one similarly can read ``X percent (ordinate) of the structure contains \textit{at least} (with respect to magnitude) Y compressive strain (abscissa)" from the distribution plot. In the case where load is applied at 0 degrees, axes 1 and 2 experience tensile and compressive axial strains, respectively. Similarly, when load is applied at 45 degrees, axis 1 experiences tensile axial strains while axis 2 experiences mostly compressive strains with a small fraction of the structure experiencing tensile strains. On the other hand, when load is applied at 90 degrees, axes 1 and 2 experience compressive and axial strains.  
%
\begin{figure}[ht]
\begin{center}
$
\begin{array}{ccc}
\includegraphics[height=4cm]{figure/rot0_FT50_strn11_128_1920_axial_ccdf_axis1_compare_stps.pdf} & 
\includegraphics[height=4cm]{figure/rot0_FT50_strn22_128_1920_axial_cdf_axis1_compare_stps.pdf} & 
\includegraphics[height=4cm]{figure/rot0_FT50_strn11_128_1920_mps_ccdf_axis1_compare_stps.pdf} \\
(a) & (b) & (c) \\ 
\includegraphics[height=4cm]{figure/rot45_FT50_strn11_128_1920_axial_ccdf_axis1_compare_stps.pdf} & 
\includegraphics[height=4cm]{figure/rot45_FT50_strn22_128_1920_axial_cdf_axis1_compare_stps.pdf} & 
\includegraphics[height=4cm]{figure/rot45_FT50_strn11_128_1920_mps_ccdf_axis1_compare_stps.pdf} \\
(d) & (e) & (f) \\
\includegraphics[height=4cm]{figure/rot90_FT50_strn11_128_1920_axial_cdf_axis1_compare_stps.pdf} & 
\includegraphics[height=4cm]{figure/rot90_FT50_strn22_ptdata_128_1920_axial_ccdf_axis1_compare_stps.pdf} & 
\includegraphics[height=4cm]{figure/rot90_FT50_strn11_128_1920_mps_ccdf_axis1_compare_stps.pdf} \\
(g) & (h) & (i) 
\end{array}
$
\end{center}
\caption{\label{fig:axial_mps_distr} Distributions of strain parallel (left column) and perpendicular (middle column) to axes 1 and 3 (top and bottom rows, respectively) indicated in Fig.\ \ref{fig:axial_schematic}. The distributions of maximum principal strain (right column) for each region of the neuron corresponding to each axes are also plotted. Distributions for three bulk strains are shown for each axis.}
\end{figure}
%

As seen in Fig.\ \ref{fig:axial_mps_distr}, the strain distributions (axial and maximum principal strains) vary most significantly for the 90 degree loading case where  strains increase in magnitude with bulk strain in the gel. On the other hand, only small variations are seen in the strain distributions for the 0 and 45 degree loading cases. The local strain amplification at 5$\%$ probability (0.05 on ordinate of distributions) are plotted as a function of bulk strain in Fig.\ \ref{fig:axial_mps_amp}. The 5$\%$ represents the portion of the structure that experiences the largest strains, and is therefore physiologically important for potential nerve damage. 
...
$
\end{center}
\caption{\label{fig:axial_mps_amp} Distributions of strain parallel (left column) and perpendicular (middle column) to axes 1 and 3 (top and bottom rows, respectively) indicated in Fig.\ \ref{fig:axial_schematic}. The distributions of maximum principal strain (right column) for each region of the neuron corresponding to each axes are also plotted. Distributions for three bulk strains are shown for each axis.}
\end{figure}
%
