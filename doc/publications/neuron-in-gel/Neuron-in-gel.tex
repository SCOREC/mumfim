...
$
\end{center}
\caption{\label{fig:neuron_cdf} Complementary cdf of normalized maximum principal strain ($\varepsilon_1$) in the neuron for applied loads at (a) 0 degrees and (b) 90 degrees. For each angle, the complementary cdf for 6$\%$, 10$\%$, 16$\%$ (pain threshold), and 20$\%$ bulk strain is shown. The values of $\varepsilon_1$ are normalized by the applied bulk strain ($\varepsilon_{\text{bulk}}$) that is applied to the surrounding collagen gel. }
\end{figure}
%
For both angles of applied load, significant portions of the neuron experience local strains that are greater than the applied bulk strain. Some regions, albeit a much smaller portion, experience local strains that are 3-5 times larger than the applied bulk strain. 

The spread of strain distribution for the applied load at 0 degrees is smaller than that of the applied load at 90 degrees. In both cases the spread of the distributions decrease as the bulk strain is larger. Interestingly, the distributions converge to the distribution corresponding to the load at the pain threshold (16$\%$). 

Additional insight can be gained by separating the strain distribution of the neuron into contributions from the cell bodies and axons. The complimentary cdfs for the cell bodies and axons are plotted in Figs.\ \ref{fig:cellbodies_cdf} and \ref{fig:axons_cdf}, respectively. 
%
\begin{figure}[ht]
\begin{center}
$
...
$
\begin{array}{cc}
\includegraphics[height=3cm]{figure/MPS_rot0_strain6.pdf} &
\includegraphics[height=3cm]{figure/MPS_rot90_strain6.pdf} \\
(a) & (b) \\
\includegraphics[height=3cm]{figure/MPS_rot0_strain16.pdf} &
\includegraphics[height=3cm]{figure/MPS_rot90_strain16.pdf} \\
(c) & (d)
\end{array}
$
\end{center}
\caption{\label{fig:MPS_neuron} Complementary cdf of normalized maximum principal strain ($\varepsilon_1$) in the axons for applied loads at (a) 0 degrees and (b) 90 degrees. For each angle, the complementary cdf for 6$\%$, 10$\%$, 16$\%$ (pain threshold), and 20$\%$ bulk strain is shown. The values of $\varepsilon_1$ are normalized by the applied bulk strain ($\varepsilon_{\text{bulk}}$) that is applied to the surrounding collagen gel.  }
\end{figure}
%
